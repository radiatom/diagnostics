...
const serverData: serverDataType = {
    ...
    resaultDiagnostic: [
        ...
        {
            id: 12,
            text: "Якщо пошкоджені магніти - замінити цілий статор, якщо пошкоджена ізоляція катушки - розібрати статор, відновити ізоляцію (є ризик, що стане гірше навіть якщо ізоляцію відновити. Після розборки статора він змінює форму і через це починає сильно чиркати якір.) рекомендовано замінити статор повністю.",
            solution: false,
        },
        {
            id: 13,
