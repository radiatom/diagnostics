...
const serverData = {
      testCard:{
            ...
            7.7: {
                  linkNumber: 7.7,
                  problem: "Дайте відповідь на питання",
                  testText: 'Чи є на якорі сліди тертя якоря об статор?',
                  instruction:'',
                  linkNumberYes: 7.8,
                  linkNumberNo: 7.8,
                  solutionYes:2.2,
            ...
            7.8: {
                  linkNumber: 7.7,
                  problem: "Дайте відповідь на питання",
                  testText: 'Магніти статора пошкодженні(дивись інструкцію)?Якщо у вас не магніти, а катушка-чи пошкоджена ізоляція катушки?',
                  instruction:'',
                  linkNumberYes: 7.1,
                  linkNumberNo: 7.1,
                  solutionYes:2.2,
