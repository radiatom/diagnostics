...
const img1 = `${process.env.PUBLIC_URL}/img/montage.jpg`
      ...
      return (
            <div className="g-5 gx-5 col-sm-12 col-md-6 col-lg-4 text-center">
                  <div className="card mx-auto" >
                        <img src={img1} className="card-img-top w-100" alt="viniko вініко автосервіс монтаж демонтаж стартера генератора" />
