    ...
    return (
        <div className={s.Diagnostics}>
            ...
            <div className={s.explanation}>
                <h5>Для кого діагностика розроблена?</h5>
                <p>
                Наша розробка для людей котрі не знають технічні аспекти та
                    терміни, але мають бажання розібратись з проблемою
                    самотужки. Також вона підійде для спеціалістів які хочуть
                    пересвідчетись в своїх здогадках, але ви мусите розуміти, що
                    терміни спрощенні для розуміння задачі людям котрі не знають
                    технічних термінів. Наприклад: обертання двигуна замість
                    обертання колінчастотго валу і т.д. Якщо у Вас є помічник,
                    скористайтесь його допомогою, так буде набагато легше та
                    веселіше.
                </p>
                <h5>Як це виглядатиме?</h5>
                <p>
                Діагностика має вигляд тестів. Для розуміня яку відповідь
                    потрібно дати, ми пробували максимально пояснити суть
                    питання в інструкціях під ними (рекомендуємо до них
                    заглядати). По закінченню діагностики Ви отримаєте
                    результат, де буде описано, що варто замінити для усунення
                    проблеми. Власні догадки, що вийшло з ладу відкладіть до
                    результатів діагностики, щоб підтвердити чи спростуавти їх.
                </p>
                <h5>
                    Діагностика проводиться коли агрегат встановлений на
                    автомобілі, і проблема постійна, або зробіть все щоб вона
                    виявила себе і лише тоді починати тест.
                </h5>
                <p>
                    Діагностику можна починати навіть якщо агрегат вже
                    демонтований, але результат буде не обєктивним.
                </p>
                <p>
                    Виберіть діагностику відштовхуючись від того{" "}
                    <span className="text-muted2">
                        як проблема себе проявляє
                    </span>
                    .
                </p>
            </div>
