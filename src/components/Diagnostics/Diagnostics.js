                        ...
                        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-5">
                              <div className={`card  ${s.card}`} >
                                    <div className="card-body">
                                          ...
                                          <p className="card-text">Щоб вияснити через яку деталь можуть виникати такі звуки, пропонуємо вам зробити власну діагностику стартера, з допомогою цієї діагностики. </p>
                                          <p>Якщо всю діагностику будите виконувати власними силами ви виясните: як буксує бендикс, і чи є підозра, що ваш бендикс не справний; чи пошкоджений у вас вінець; в якому стані у вас втулки, підшипники, редуктор, якір стартера. </p>
