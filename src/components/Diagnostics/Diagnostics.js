                        ...
                        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-5">
                              <div className={`card  ${s.card}`} >
                                    <div className="card-body">
                                          ...
                                          <p>Якщо всю діагностику будите виконувати власними силами ви виясните: як буксує бендикс, і чи є підозра, що ваш бендикс не справний; чи пошкоджений  вінець; в якому стані  втулки, підшипники, редуктор, якір стартера. </p>
