    ...
    return (
        <div className={`card m-1 ${s.card}`} >
                  <div className="card-body">
                        ...
                        <p className="card-text">Щоб зробити повноцінне дефектування потрібне спеціальне обладнання. Без нього за допомогою діагностики можливо перевірити лише: підшипники, шків, колектор, щітки, обрив катушки якоря, явні сліди згорівшого діодного моста та пошкодження статора.</p>
                        <nav>
