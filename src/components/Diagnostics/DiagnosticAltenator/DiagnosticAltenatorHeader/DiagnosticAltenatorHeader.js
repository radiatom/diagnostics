      ...
      return (
            <div>
                  ...
                  <div className={s.explanation}>
                        ...
                        <h5>Дана діагностика буде обєктивною, якщо ваш акумулятор свинцевий (Pb). Іншої будови акумулятори мають свою норму напруги для хорошої зарядки акумулятора. Тому генератор буде видавати інші показини.</h5>
