      ...
      return (
            <div className={`card m-1 ${s.card}`} >
                  <div className="card-body">
                        ...
                        <p className="card-text">Первірка проводки та акумулятора.</p>
                        <p className="card-text"></p>
                        <p className="card-text"></p>
                        <nav>
                              <NavLink to="/Diagnostics/Test/163"><button className={`btn btn-warning ${s.button}`}>Почати діагностику</button></NavLink>
                        </nav>
                  </div>
            </div>
      );
