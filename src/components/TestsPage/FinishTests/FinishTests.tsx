...
const FinishTests: React.FC<object> = () => {
                        ...
                        {resault[1] === undefined || resault[1].text === '' ?
                              ...
                              <div>
                                    ...
                                    <div className='m-4'>
                                          ...
                                          <NavLink to="/Diagnostics"><button onClick={() => dispatch(updateRes())} className="btn btn-warning">Почати нову діагностику</button></NavLink>
                                    </div>
                              </div>
                        }
                  </div>
