    ...
    <div className="contact">
      ...
      <div className="contact__body">
        ...
        <div className="contact__info" ref={contactRef}>
          <ul
            className={
              active ? "textInfo textInfo_active textInfo_1" : "textInfo"
            }
          >
            <b>Графік роботи:</b>
          ...
          <p
            className={
              active ? "textInfo textInfo_active textInfo_2" : "textInfo"
            }
          >
          ...
          <p
            className={
              active ? "textInfo textInfo_active textInfo_3" : "textInfo"
            }
          >
            Територіально м.Луцьк,<b> біля заводу ModernExpo</b>, точна адреса:{" "}
            <b>с. Струмівка вул. Рівненська 8.</b>
          </p>
          <p
            className={
              active ? "textInfo textInfo_active textInfo_4" : "textInfo"
            }
          >
          ...
          <p
            className={
              active ? "textInfo textInfo_active textInfo_5" : "textInfo"
            }
          >
