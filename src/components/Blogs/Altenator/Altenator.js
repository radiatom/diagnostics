...
const Altenator = () => {
      return (
            <div className={s.Altenator}>
                  ...
                  <img src={img3} alt="" />
                  <p>Обгінна муфта — це храповий механізм, завдяки якому тяга передається при обертанні тільки в один бік. Це сильно збільшує ресурс нагяжного механізму, роликів, приводного ремня, підшипників генератора.</p>
                  ...
                  <ul>
                        Механічні:
                        <li>знос привідного шківа генератора, заклинювання, ослаблення (пропускання в обидві сторони) .</li>
                        ...
                        <li>поломку реле регулятора;</li>
                        <li>замикання або обрив діода діодного моста.</li>
                  </ul>
            </div>
      );
}
