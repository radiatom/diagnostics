      ...
      return (
            <div className={s.starter}>
                  ...
                  <ul>
                        ...
                        <li>Включайте стартер не більше ніж на 10 сек. Якщо двигун автомобіля не запустився, секунд на 30 залиште в спокої стартер, так як він охолоджується дуже повільно. Після 2-3 безуспішних пусків двигуна зробіть приблизно 4-5 хвилинну паузу;</li>
                        ...
                        <li>Не здійснюють збирання і розбирання стартера при відсутності досвіду в цій справі.</li>
                  </ul>
            </div>
      );
}
